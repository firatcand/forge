...
// A payload's canonical hash is locked BY VALUE so an accidental change to the
// canonical-object shape (which would silently rotate every existing v1 journal
// hash) trips this test.
test('amendPayloadHash: BASE_PAYLOAD hash is stable (legacy-locked)', () => {
