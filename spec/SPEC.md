...
| Section | Status |
|---|---|
| §Data model — `.forge/settings.yaml` schema (`AgentsSchema`) | **Amended** — gains `enabled_root_files: ('claude_code' \| 'codex' \| 'gemini')[]` (default `[primary_host_cli]`); inline edit in Phase A |
